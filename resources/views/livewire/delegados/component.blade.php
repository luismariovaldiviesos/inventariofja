<div>
                        ...
                        <table class="table">
                            <thead>
                                <tr class="text-theme-1">
                                    ...
                                    <th class="border-b-2 dark:border-dark-5 whitespace-nowrap" >UNIDAD JUDICIAL</th>
                                ...
                                @forelse ($delegados as $delegado )
                                    <tr class=" dark:bg-dark-1 {{ $loop->index % 2> 0 ? 'bg-gray-200' : '' }}">
                                        ...
                                        <td class="dark:border-dark-5">
                                            <h6 class="mb-1 font-medium">{{ $delegado->iddelegacion }}</h6>

                                        </td>

                                        <td class="dark:border-dark-5">
                                            <h6 class="mb-1 font-medium">{{ $delegado->user }}</h6>

                                        </td>

                                        <td class="dark:border-dark-5">
                                            <h6 class="mb-1 font-medium">{{ $delegado->unidad }}</h6>
                                        ...
                                        <td class="dark:border-dark-5 text-center">
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <button class="btn btn-warning text-white border-0 ml-3"
                                                    wire:click.prevent="Edit({{ $delegado->iddelegacion }})"
                                                    type="button">
    ...
    @else
        ...
        @include('livewire.delegados.form')
