...
class RatonExportInventario implements  FromQuery, WithHeadings, WithCustomStartCell, WithTitle, WithStyles
{
    /**
    ...
    */
    ...
    {
        return Raton::query()->join('users as u','u.id','ratons.user_id')
